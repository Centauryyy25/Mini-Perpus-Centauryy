...
import { ArticleCardHorizontalSkeleton } from "@/components/ui/Skeleton";
    ...
    <div className="bg-[#fceade] text-black min-h-screen font-space">
      ...
      <div className="flex items-center justify-between px-4 py-2 border-b border-black relative">
          ...
          <div className="drawer-side">
            ...
            <div className="menu bg-base-200 text-base-content trabs w-full min-h-full p-4 relative">
              ...
              <div className="py-8 space-y-2">
                ...
                <li><Link href="/articles" className="text-lg">📚 Research Articles</Link></li>
                <li><a href="#about" className="text-lg">ℹ️ About</a></li>
                <li><a href="#projects" className="text-lg">🛠️ Projects</a></li>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="absolute left-1/2 transform -translate-x-1/2 flex items-center space-x-2">
          <Image src="/asset/favicon.png" width={28} height={28} alt="Centauryy Logo" />
          <h1 className="text-xl font-bold font-space">Centauryy</h1>
        </div>
      ...
      <div className="text-center h-125 py-8 flex flex-col justify-center items-center">
        <h1 className="text-3xl tracking-wider">Articles &</h1>
      ...
      {/* Footer */}
      <footer className="text-center bg-black text-white py-6 border-t-2 border-black">
        <div className="flex flex-col gap-4 px-4">
          <div className="flex items-center justify-center gap-2">
            <Image src="/asset/favicon.png" width={20} height={20} alt="Centauryy" />

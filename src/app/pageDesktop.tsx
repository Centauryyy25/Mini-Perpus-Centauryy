...
import BrutalCarousel from "@/components/features/Carousel";
...
const HomePageDesktop = () => {
  ...
  return (
    <div className="bg-[#fceadd] text-black overflow-auto scrollbar-hide font-sans">
        ...
        <header className="flex justify-between items-center px-6 py-4 border-b-2 border-black">
          <div className="flex items-center space-x-2">
            <div className="text-2xl">
              <Image src="/asset/favicon.png" width={40} height={40} className="w-10 h-10" alt="Centauryy Logo" />
            </div>
          ...
          <nav className="hidden md:flex font-space  space-x-6 text-sm">
            ...
            <div className="dropdown dropdown-bottom">
              <Link href="/articles" tabIndex={0} role="button" className="hover:underline">Research Articles</Link>
              <ul tabIndex={0} className="dropdown-content menu bg-[#FCEEE3] transition rounded-box z-10 w-52 p-2 shadow-xl border-2 border-black">
                <li><Link href="/articles">All Articles</Link></li>
                <li><Link href="/articles">Technology</Link></li>
                <li><Link href="/articles">Components</Link></li>
                <li><Link href="/articles">Networking</Link></li>
                <li><Link href="/articles">Global Access</Link></li>
              </ul>
            </div>
      ...
      {/* Footer */}
      <footer className="px-6 py-6 border-t-2 border-black text-center bg-black text-white">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex items-center gap-2">
              <Image src="/asset/favicon.png" width={24} height={24} alt="Centauryy" />
              <span className="font-bold">Centauryy</span>
            </div>
            ...
            <p className="text-xs text-gray-400">© 2025 Centauryy. All rights reserved.</p>
          </div>
        </div>
      </footer>
